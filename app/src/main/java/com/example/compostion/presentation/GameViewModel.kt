...
import com.example.compostion.data.GameRepositoryImpl
...
import com.example.compostion.domain.usecases.GenerateQuestionUseCase
import com.example.compostion.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun updateProgress () {
        ...
        _progressAnswer.value = String.format(
            ...
            countOfRightAnswers, gameSettings.minCountRightOfAnswers
        )
        _enoughCount.value = countOfRightAnswers >= gameSettings.minCountRightOfAnswers
